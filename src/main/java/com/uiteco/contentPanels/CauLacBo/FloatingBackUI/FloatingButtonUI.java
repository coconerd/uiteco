package com.uiteco.contentPanels.CauLacBo.FloatingBackUI;
...
import com.uiteco.contentPanels.CauLacBo.FloatingBackUI.Shadow.ShadowRenderer;
 ...
 * @author RAVEN
 */
public class FloatingButtonUI extends LayerUI<ScrollableContentPanel> {
    private CauLacBoPanel mainform;
    ...
    public FloatingButtonUI(CauLacBoPanel mainform) {
        Start();
    ...
    private void Start()
    {
        image = new ImageIcon(getClass().getResource("/CauLacBoResources/BackUI.png")).getImage();
    }
    
    public void setMainForm(CauLacBoPanel mainform) 
    {
        this.mainform = mainform;
    }
    ...
    public void paint(Graphics grphcs, JComponent jc) {
        ...
        if (mousePressed) {
            g2.setColor(new Color(36,100,255));
        } else if (mouseHovered) {
            g2.setColor(new Color(59,117,255));
        } else {
            g2.setColor(new Color(73,127,255));
        }
        if (imageShadow == null) {
    ...
    @Override
    protected void processMouseEvent(MouseEvent me, JLayer<? extends ScrollableContentPanel> jlayer) {
        if (mouseHovered) {
            me.consume();
        }
    ...
    @Override
    protected void processMouseMotionEvent(MouseEvent me, JLayer<? extends ScrollableContentPanel> jlayer) {
