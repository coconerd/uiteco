...
public class CustomButton extends JButton {
    ...
    private PropertyChangeSupport listenerChange = new PropertyChangeSupport(this);
    private boolean isSelected = false;
    
    
    public void _addPropertyChangeListener(PropertyChangeListener listener) {
        listenerChange.addPropertyChangeListener(listener);
    }

    public void _removePropertyChangeListener(PropertyChangeListener listener) {
        listenerChange.removePropertyChangeListener(listener);
    }
