//
//package com.uiteco.OfCuocThiRightPanel.rightPanel;
//
...
//
//public class circleButton extends LayerUI<CuocThiRightPanel>{
//    private Shape shape;
...
//
//    public circleButton() {
//        image = new ImageIcon(getClass().getResource("/plus.png")).getImage();
//    }
//
//    @Override
...
//
//    @Override
//    protected void processMouseEvent(MouseEvent me, JLayer<? extends CuocThiRightPanel> jlayer) {
//        if (mouseHovered) {
//            me.consume();
//        }
...
//                jlayer.repaint(shape.getBounds());
//                if (mouseHovered) {
//                    CuocThiRightPanel main = jlayer.getView();
//                    main.actionButton();
//                }
//            }
//        }
...
//
//    @Override
//    protected void processMouseMotionEvent(MouseEvent me, JLayer<? extends CuocThiRightPanel> jlayer) {
