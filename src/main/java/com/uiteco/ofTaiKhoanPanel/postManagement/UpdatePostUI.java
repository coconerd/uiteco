...
public class UpdatePostUI extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        eventSettingBtn = new com.uiteco.components.RoundedImagePanel();
        ...
        roundedPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, roundedPanel1Layout.createSequentialGroup()
                .addGap(199, 199, 199)
                .addComponent(roundedPanel4, javax.swing.GroupLayout.DEFAULT_SIZE, 733, Short.MAX_VALUE)
                .addContainerGap())
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, roundedPanel1Layout.createSequentialGroup()
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        ...
        roundedPanel5.setRoundBottomLeft(12);
        roundedPanel5.setRoundBottomRight(12);
        roundedPanel5.setRoundTopLeft(12);
        roundedPanel5.setRoundTopRight(12);
        ...
        eventSettingBtn.setToolTipText("Điều chỉnh thời gian sự kiện");
        eventSettingBtn.setImage(new javax.swing.ImageIcon(getClass().getResource("/icons8-event-48.png"))); // NOI18N
        eventSettingBtn.setMinimumSize(new java.awt.Dimension(40, 40));
        eventSettingBtn.setPreferredSize(new java.awt.Dimension(40, 40));
        eventSettingBtn.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                eventSettingBtnMouseClicked(evt);
            }
            public void mouseEntered(java.awt.event.MouseEvent evt) {
                eventSettingBtnMouseEntered(evt);
            }
            public void mouseExited(java.awt.event.MouseEvent evt) {
                eventSettingBtnMouseExited(evt);
            }
        });

        javax.swing.GroupLayout eventSettingBtnLayout = new javax.swing.GroupLayout(eventSettingBtn);
        eventSettingBtn.setLayout(eventSettingBtnLayout);
        eventSettingBtnLayout.setHorizontalGroup(
            eventSettingBtnLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGap(0, 40, Short.MAX_VALUE)
        );
        eventSettingBtnLayout.setVerticalGroup(
            eventSettingBtnLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGap(0, 40, Short.MAX_VALUE)
        );
        ...
        utilPanel.add(eventSettingBtn, gridBagConstraints);
    ...
    private void eventSettingBtnMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_eventSettingBtnMouseClicked
        // TODO add your handling code here:
        _showEventSetting();
    }//GEN-LAST:event_eventSettingBtnMouseClicked

    private void eventSettingBtnMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_eventSettingBtnMouseEntered
        // TODO add your handling code here:
        eventSettingBtn.setBorder(new LineBorder(Color.WHITE, 2, true));
    }//GEN-LAST:event_eventSettingBtnMouseEntered

    private void eventSettingBtnMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_eventSettingBtnMouseExited
        // TODO add your handling code here:
    ...
    private void _updatePost() {
        try {
            ...
            int postType = eventSetting.getPostType();
            boolean enrollable = eventSetting.isEnrollable();
    ...
    private void _showEventSetting() {
        createDialog("Loại bài đăng", eventSetting, eventSetting.getOkLabel(), eventSetting.getCancelLabel());
    }
    ...
    public static void createDialog(String dialogName, Component child, Component... closeComponents) {
        JDialog dialog = new JDialog(App.getMainFrame(), dialogName, false);
        dialog.setLayout(new GridLayout(1, 1, 0, 0));
        dialog.setSize(child.getPreferredSize());
        dialog.add(child);
        ...
        Dimension dialogSize = dialog.getSize();
        dialog.setLocation((screenSize.width - dialogSize.width) / 2, (screenSize.height - dialogSize.height) / 2);
        for (Component comp : closeComponents) {
    ...
    private com.uiteco.components.RoundedImagePanel eventSettingBtn;
